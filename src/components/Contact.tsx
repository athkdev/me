                ...
                <ModalBody>
                    ...
                    <div className="mt-2 bg-orange-100 p-1  rounded">
                        <p className=" text-xs text-red-300">
                            Heads-up: this feature is currently <span className="text-red-400 underline underline-offset-4">under re-construction</span> because of going out of limit for emails on the free-tier haha.
                        </p>
                        <p className="mt-2 text-red-300 text-xs">
                            Feel free to contact me at <code className="bg-gray-300 p-1 text-white rounded">kamble.ath@northeastern.edu</code>
                        </p>
                    </div>
