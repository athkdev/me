...
const Nav = ({
    ...
    useEffect(() => {
        // set cookie as well
        setTitleColorStyle(prev => {
            return prev === TAILWIND.color.primary ? TAILWIND.color.secondary : TAILWIND.color.primary;
        })
                ...
                <Center className="mx-auto">
                    <div>
                        <h1 className="font-thin text-2xl md:text-4xl hover:-translate-y-1 transition ease-in-out">
                            My name is{" "}
                            <span className={`name underline underline-offset-2 hover:bg-amber-400 cursor-pointer ${titleColorStyle}`}>
